...
public class BaseFile {
	...
	{
		prop=new Properties();
		FileInputStream config=new FileInputStream("C:\\personal project\\holistapet product Validation code\\src\\main\\java\\holistapetSite\\data.properties");
		prop.load(config);
		String browser=prop.getProperty("browser");
		if(browser.equals("chrome"))
		{
			System.setProperty("webdriver.chrome.driver","C:\\personal project\\holistapet product Validation code\\chromedriver.exe");
